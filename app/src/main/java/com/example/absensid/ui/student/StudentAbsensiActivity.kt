...
import kotlinx.android.synthetic.main.activity_student_absensi.*
import org.jetbrains.anko.startActivity
import org.jetbrains.anko.toast

class StudentAbsensiActivity : AppCompatActivity(), AbsensiAdapter.ItemEvents {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_student_absensi)
